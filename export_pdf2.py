"""
Export Draft 2.ipynb to PDF.

Same three-step pipeline as export_pdf.py:
  Step 1: Execute notebook and convert to HTML (nbconvert).
  Step 2: Inject compression CSS.
  Step 3: Print to PDF via Playwright + headless Chromium.

Output: docs/Report/Draft 2.pdf
"""
...
NOTEBOOK  = ROOT / 'Draft 2.ipynb'
HTML_OUT  = ROOT / 'Draft 2.html'
PDF_OUT   = ROOT / 'Draft 2.pdf'
...
.title-page { page-break-after: always !important; }
